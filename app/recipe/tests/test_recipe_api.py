...
class PrivateRecipeAPITest(TestCase):
    ...
    def test_filter_recipes_by_tags(self):
        ...
        recipe_1 = sample_recipe(user=self.user, title='Thai begetable curry')
        ...
        serializer_recipe_1 = RecipeSerializer(recipe_1)
        serializer_recipe_2 = RecipeSerializer(recipe_2)
        serializer_recipe_3 = RecipeSerializer(recipe_3)

        self.assertEqual(res.status_code, status.HTTP_200_OK)
        self.assertEqual(len(res.data), 2)

        self.assertIn(serializer_recipe_1.data, res.data)
        self.assertIn(serializer_recipe_2.data, res.data)
        self.assertNotIn(serializer_recipe_3.data, res.data)

    def test_filter_recipes_by_ingredients(self):
        """Test returning recipes with specific ingredients"""
        ingredient_1 = sample_ingredient(user=self.user, name='Vegan')
        ingredient_2 = sample_ingredient(user=self.user, name='Vegetarian')
